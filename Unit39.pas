...
type
  TForm39 = class(TForm)
    Label1: TLabel;
    Label2: TLabel;
    DateTimePicke1: TDateTimePicker;
...
begin
   ...
   p:=strtoint(copy(datetostr(datetimepicke1.DateTime),1,2));
   case p of
...
{   1: smon:='02';
 ...
 {  1: smon:='01';
   ...
   smon:=copy(datetostr(DateTimePicke1.Date),4,2);
   tv:=tstringlist.Create;
   tv.LoadFromFile('Tmp.txt');
   syear:=inttostr(mainform.year);

   //30.04.2015
   sday:=copy(datetostr(datetimepicke1.DateTime),1,2);
{   sv:='08='+'01'+smon+syear+'='+copy(datetostr(DateTimePicker2.Date),1,2)+copy(datetostr(DateTimePicker2.Date),4,2)+syear+'='+copy(datetostr(DateTimePicker3.Date),1,2)+copy(datetostr(DateTimePicker3.Date),4,2)+syear
   ...
   sv:='09='+sday+smon+syear+'='+copy(datetostr(DateTimePicker2.Date),1,2)+copy(datetostr(DateTimePicker2.Date),4,2)+syear+'='+copy(datetostr(DateTimePicker3.Date),1,2)+copy(datetostr(DateTimePicker3.Date),4,2)+syear
   +'='+copy(datetostr(DateTimePicke1.Date),1,2)+copy(datetostr(DateTimePicke1.Date),4,2)+syear
   +'=1030'+'='+'300926'+'=11='+k2+'='+'#f11wf'+inttostr(mon)+den+'.d'+den+'1'+'='+'      '+'='+'                                                                ';
   mPreviewForm.Memo1.Lines.Insert(1,sv);
   tv.Insert(0,sv);
   tv.SaveToFile('#f11wf'+inttostr(form39.mon)+form39.den+'.d'+form39.den+'1');
//--------------
